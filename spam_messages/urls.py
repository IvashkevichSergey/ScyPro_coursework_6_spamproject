...
from spam_messages.views import MessageListView, MessageCreateView, \
...
urlpatterns = [
    ...
    path('update_message/<int:pk>/', MessageUpdateView.as_view(),
         name='update'),
    path('delete_message/<int:pk>/', MessageDeleteView.as_view(),
         name='delete'),
]
