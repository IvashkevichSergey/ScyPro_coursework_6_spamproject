...
urlpatterns = [
    ...
    path('spam_list', cache_page(60)(SpamListView.as_view()), name='spam_list'),
    ...
    path('users_list/', cache_page(60)(UserListView.as_view()), name='users_list'),
    path('user_toggle_status/<int:pk>/', toggle_user_status, name='user_toggle_status'),

    path('logs_list/<int:pk>', cache_page(60)(LogsListView.as_view()), name='logs_list')
]
